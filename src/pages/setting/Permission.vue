...
<div class='permission'>
  <el-card>
    <div slot="header" class="card-header">
      ...
      <el-button icon='plus' @click="handleAdd(addOBJ.id, addOBJ.level, addOBJ.name)" type="primary" class="header-left" onloadedmetadata="">新增</el-button>
    </div>
    <!-- 列表 -->
    <div>
      <el-tree :default-expanded-keys='openKey' :filter-node-method="filterNode" ref="tree2" accordion style="border: none;width: 35%;font-size: 16px" :data='permissionList' :props="defaultProps" node-key="id" :expand-on-click-node="false" :render-content="renderContent"
        v-loading='loading' :highlight-current='myOBJ'>
      </el-tree>
    </div>
