...
<div id='role'>
  <el-card class="box-card">
    ...
    <div slot="header" class="card-header">
      <el-button @click="handleAdd" type="primary" icon="plus" class="header-right">添加</el-button>
    </div>
